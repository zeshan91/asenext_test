  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('asenext_test')->notice('Created new student %label', $logger_arguments);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The student %label has been updated.', $message_arguments));
        $this->logger('asenext_test')->notice('Updated student %label.', $logger_arguments);
        break;
    }

    $form_state->setRedirect('entity.student.collection');
