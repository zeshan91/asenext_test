...
class StudentListBuilder extends EntityListBuilder {
  ...
  public function buildHeader() {
    ...
    $header['s_class'] = $this->t('Class');
    $header['s_rollno'] = $this->t('Roll No');
    $header['s_phone'] = $this->t('Contact No');
  ...
  public function buildRow(EntityInterface $entity) {
    /** @var \Drupal\asenext_test\StudentInterface $entity */
    $row['id'] = $entity->id();
    $row['label'] = $entity->toLink();
    $row['s_class'] = $entity->s_class->entity->label();
    $row['s_rollno'] = $entity->get('s_rollno')->getString();
    $row['s_phone'] = $entity->get('s_phone')->getString();
